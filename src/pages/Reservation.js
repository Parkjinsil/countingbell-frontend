      ...
      <Reserve id="reserve">
        ...
        <div id="reserve-center">
          <ReserveCenterHeader class="reserve-center-header">
            <button><span>4</span><span class="dot">수</span></button>
            <button><span>5</span><span class="dot">목</span></button>
            <button><span>6</span><span class="dot">금</span></button>
            <button><span>7</span><span class="dot">토</span></button>
            <button><span>8</span><span class="dot">일</span></button>
            <button><span>9</span><span class="dot">월</span></button>
            <button><span>10</span><span class="dot">화</span></button>
          </ReserveCenterHeader>
